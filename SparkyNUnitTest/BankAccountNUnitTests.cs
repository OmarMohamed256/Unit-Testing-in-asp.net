...
namespace Sparky
{
    ...
    public class BankAccountNUnitTests
    {
        ...
        [Test]
        [TestCase(200, 100)] // 15.9
        [TestCase(200, 150)] // 15.9
        ...
        public void BankLogDummy_LogMockStringOutputStr_ReturnTrue()
        {
            ...
            // logMock.Setup(u => u.LogWithOutputResult(It.Is<string>(s => !string.IsNullOrEmpty(s)), out desiredOutput)).Returns(true);
        ...
        [Test]
        public void BankLogDummy_SaveAndGetLogTypeAndSeveriyMock_ReturnTrue()
        {
            var logMock = new Mock<ILogBook>();

            logMock.SetupProperty(u => u.LogSeverity).SetReturnsDefault(10);
        ...
        [Test]
        public void BankLogDummy_VerifyExample_ReturnTrue()
        {
            var logMock = new Mock<ILogBook>();
